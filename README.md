...
This project is designed for the **Next Level Web Development ** to help learners practice Prisma hands-on by building a blog platform.
...
```bash
git clone https://github.com/Subahan-1D/next-blog-stater.git
...
This starter pack is part of the **Next Level Web Development** curriculum.
